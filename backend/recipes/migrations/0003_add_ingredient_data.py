...
def add_ingredient_data(apps: Apps, *args, **kwargs) -> None:
    ...
    ingredient_model = apps.get_model(app_label='recipes', model_name='Ingredient')
...
def delete_ingredient_data(apps: Apps, *args, **kwargs) -> None:
    ...
    ingredient_model.objects.filter(name__in=names,  measurement_unit__in=measurement_units).delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_ingredient_data, reverse_code=delete_ingredient_data)
    ]
