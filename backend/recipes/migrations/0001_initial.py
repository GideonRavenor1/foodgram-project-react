    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(help_text='Время приготовления в минутах', validators=[django.core.validators.MinValueValidator(limit_value=1, message='Время должно быть больше 1 минуты')], verbose_name='Время приготовления')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Название')),
                ('color', models.CharField(help_text='Цветовой HEX-код', max_length=7, verbose_name='Цвет')),
                ('slug', models.SlugField(help_text='Неофициальное имя, часть URL адреса', verbose_name='Слаг')),
            ],
            options={
                'verbose_name': 'Тег',
